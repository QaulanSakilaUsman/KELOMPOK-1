                    ...
                    <div class="row">
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="background-color: #9DC3E6; padding: 15px;">
                          ...
                          <h3 style="color: #222A35; padding-bottom:20px;">Data Surat Masuk</h3>
                          <p style="color:#222A35;">Telah Diarsipkan</p>
                        </div>
                      </div>
                      <?php include '../koneksi/koneksi.php';
                       ...
                       <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="background-color: #FFD966; padding: 15px;">
                          ...
                          <h3 style="color: #222A35; padding-bottom:20px;"> Data Surat Keluar</h3>
                          <p style="color:#222A35;">Telah Diarsipkan</p>
                        </div>
                      </div>
                      <?php include '../koneksi/koneksi.php';
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="background-color:#FF3300; padding: 15px;">
                          ...
                          <h3 style="color: #222A35; padding-bottom:20px;">Data Bagian</h3>
                          <p style="color:#222A35;">Telah Didaftarkan</p>
                        </div>
                      </div>
                    </div>
                </div>
