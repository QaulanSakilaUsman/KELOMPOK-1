    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa-solid fa-file-arrow-down"></i>&nbsp;DAFTAR SURAT KELUAR</h2>
                        <div class="clearfix"></div>
                    </div>
                    <form action="lap_sk.php" method="post" >
                    ...
                    <form action="cetak_sk.php" method="post" target="_blank">
                            ...
                            <thead>
                                ...
                                <?php
                                    ...
                                    if (isset($_POST['filter'])){
                                        ...
                                        $sql1 = mysqli_query($db, "SELECT * FROM tb_suratkeluar WHERE tanggalsurat_suratkeluar BETWEEN '$tglawal' AND '$tglakhir'");
                                    }else {
                                        $sql1 = mysqli_query($db,"SELECT * FROM tb_suratkeluar ");
                                    }                       
